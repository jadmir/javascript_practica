...
function mostrarCotizacionHtml(cotizacion) {
  ...
  const ulimasHoras = document.createElement('p')
  ulimasHoras.innerHTML = `<p>Variacion ultimas 24 horas <span>${CHANGEPCT24HOUR}%</span></p>`
  ...
  resultado.appendChild(ulimasHoras)
